  ...
  return (
    <Button
      ...
      className={cn(
        ...
        animated && "hover:scale-105 active:scale-95 focus:scale-95",
  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-hackathon-dark/30 animate-fade-in">
      <aside className="w-64 bg-white dark:bg-hackathon-dark border-r border-gray-200 dark:border-gray-800 hidden md:flex flex-col">
        <div
          className="h-16 flex items-center px-4 border-b border-gray-200 dark:border-gray-800 cursor-pointer hover:scale-105 transition-transform duration-200"
          onClick={() => navigate("/")}
          role="button"
          tabIndex={0}
        ...
        >
          ...
          <span className="ml-3 font-bold text-lg gradient-text animate-gradient-x select-none">
            HackathonVerse
          </span>
        </div>
        ...
        <nav className="flex-1 overflow-y-auto py-4" aria-label="Dashboard Navigation">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-800 px-2 space-y-2">
            ...
            {showRegisterButton && (
              <Button
                className="w-full mt-4 btn-primary animate-pulse animate-delay-300 hover:scale-105 hover:bg-gradient-to-l focus:scale-110 active:scale-95 transition-transform"
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-800 animate-fade-in">
          <div className="flex items-center">
            <Avatar className="h-9 w-9 ring-2 ring-primary/30 hover:scale-110 transition-transform duration-150 cursor-pointer" onClick={() => navigate("/profile")} tabIndex={0} aria-label="Profile">
              <AvatarImage src="https://github.com/shadcn.png" />
              <AvatarFallback>US</AvatarFallback>
            </Avatar>
            <div className="ml-3">
              <p className="text-sm font-medium animate-fade-in select-none">User Name</p>
              <p className="text-xs text-gray-500 dark:text-gray-400 capitalize select-none">{userRole}</p>
            </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="h-16 bg-white dark:bg-hackathon-dark border-b border-gray-200 dark:border-gray-800 flex items-center justify-between px-4 animate-fade-in">
          <div className="flex items-center md:hidden">
            <Button variant="ghost" size="icon" className="hover:scale-110 focus-visible:ring-2 focus-visible:ring-primary">
          ...
          <div className="flex-1 max-w-md mx-4 md:mx-0">
            <div className="relative">
              ...
              <Input placeholder="Search..." className="pl-10 bg-gray-50 dark:bg-hackathon-dark/60 border-none focus:ring-2 focus:ring-primary" />
            </div>
          </div>
          ...
          <div className="flex items-center space-x-2">
            <Button
              variant="ghost"
              size="icon"
              className="relative animate-pulse hover:scale-110 focus:scale-110 transition-transform"
        ...
        <main className="flex-1 overflow-y-auto bg-gray-50 dark:bg-hackathon-dark/30 p-6 animate-fade-in">
          <div className="mb-8">
            <h1 className="text-2xl md:text-3xl font-bold gradient-text animate-gradient-x select-none">{title}</h1>
            {subtitle && <p className="text-gray-600 dark:text-gray-300 mt-1 animate-fade-in select-none">{subtitle}</p>}
          </div>
          {children}
        </main>
      </div>
